...
```bash
  bash -c "$(curl -L https://raw.githubusercontent.com/cubanitoalex/MikroTik-CHR-on-VPS/main/mik-6.sh)"
```

For MikroTik 7.10.2

```bash
  bash -c "$(curl -L https://raw.githubusercontent.com/cubanitoalex/MikroTik-CHR-on-VPS/main/mik-7.sh)"
```
